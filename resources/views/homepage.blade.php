     ...
     <div class="aa-slider-area">
       <div id="sequence" class="seq">
          <ul class="seq-canvas">
             ...
             <li>
               <div class="seq-model">
                 <img data-seq src="{{URL::asset('img/slider/2.jpg')}}" alt="Wristwatch slide img" />
               </div>
               <div class="seq-title">
             ...
             <li>
               <div class="seq-model">
                 <img data-seq src="{{URL::asset('img/slider/3.jpg')}}" alt="Women Jeans slide img" />
               </div>
               <div class="seq-title">
                 <span data-seq>Save Up to 75% Off</span>                
             ...
             <li>
               <div class="seq-model">
                 <img data-seq src="{{URL::asset('img/slider/4.jpg')}}" alt="Shoes slide img" />
               </div>
               <div class="seq-title">
                 <span data-seq>Save Up to 75% Off</span>                
             ...
             <!-- single slide item -->  
              <li>
               <div class="seq-model">
                 <img data-seq src="{{URL::asset('img/slider/5.jpg')}}" alt="Male Female slide img" />
               </div>
               <div class="seq-title">
