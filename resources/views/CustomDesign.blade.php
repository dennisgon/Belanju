...
@section('konten')
    ...
    <link href="{{asset('custom/css/api.css')}}" rel="stylesheet">
    <link href="//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">

    <script type="text/javascript" src="{{asset('custom/js/html2canvas.js')}}"></script>

    <script src="{{asset('custom/js/jquery.form.js')}}"></script>
    <script src="{{asset('custom/js/mainapp.js')}}"></script>
    <link rel="stylesheet" href="{{asset('custom/css/jquery-ui.css')}}" />
    <script src="{{asset('custom/js/jquery-ui.js')}}"></script>
    ...
    <div class="container design_api_container">
        <div class='design_api'>
            ...
            <div id='options'>
                <div class="T_type">
                    <div id="radio1" ><img src="{{asset('custom/images/menu_icons/submenu/tee.jpg')}}" width="100%" height="100%" />
                    </div>
                    <!--<div id="radio2" ><img src="tdesignAPI/images/menu_icons/submenu/collar.jpg" width="100%" height="100%" />
                    </div>-->
                    <div id="radio3" ><img src="{{asset('custom/images/menu_icons/submenu/hoodie.jpg')}}" width="100%" height="100%" />
                    </div>
                </div>
                ...
                <div class="default_samples">
                    ...
                    <?php
                    $dir    = 'custom/images/Images';
                    $files1 = scandir($dir);
                    //$files2 = scandir($dir, 1);
                    foreach ($files1 as &$value) {
                        if (strpos($value,'.png') !== false) {
                            //echo 'true';
                            echo '<div class="sample_icons"><img src="custom/images/Images/' .$value. '" width="100%" height="100%" /></div>' ;
            ...
            <div id='view_mode'>
                <div  class="mode"><img id="o_front" src="{{asset('custom/images/product/tee/black/black_front.png')}}" width="100%" height="80%" />FRONT
                </div>
                <div  class="mode"><img id="o_back" src="{{asset('custom/images/product/tee/black/black_back.png')}}" width="100%" height="80%" />BACK
                </div>
                <div class="mode">
