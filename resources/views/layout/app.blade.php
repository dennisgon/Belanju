                ...
                <div class="aa-cartbox">
                  ...
                  <div class="aa-cartbox-summary">
                    <ul>
                      ...
                      <li>
                        <a class="aa-cartbox-img" href="#"><img src="{{asset($row->options->image)}}" alt="img"></a>
                        <div class="aa-cartbox-info">
                          <h4><a href="#">{{$row->name}}</a></h4>
                          <p>{{$row->qty}} x Rp {{$row->price}}</p>
                        </div>
                        <a class="aa-remove-product" href="{{route('cart.remove',$row->rowId)}}"><span class="fa fa-times"></span></a>
                      </li>
                        @endforeach
                      <li>
                    ...
                    <a class="aa-cartbox-checkout aa-primary-btn" href="{{route('order.create')}}">Order</a>
                  </div>
                </div>
                <!-- / cart box -->
                <!-- search box -->
          ...
          <div class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-collapse collapse">
              ...
              <ul class="nav navbar-nav">
                ...
                <li><a href="{{route('tampilkan',$row->id)}}">{{$row->nama}} <span class="caret"></span></a>
                  ...
                  @endforeach
               <li><a href="http://localhost/custom/">Custom</a>
                </li>
              </ul>
            </div><!--/.nav-collapse -->
          </div>
